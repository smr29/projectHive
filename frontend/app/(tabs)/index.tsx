...
const styles = StyleSheet.create({
  ...
  authSection: { padding: 20, alignItems: 'center', backgroundColor: '#E0F7FA' },
  ...
  summaryContainer: { flexDirection: 'row', justifyContent: 'center', marginTop: 10 },
  summaryCard: { width: 150, margin: 10, padding: 10, alignItems: 'center', borderRadius: 8 },
  tealCard: { backgroundColor: '#E0F2F1', borderColor: '#057C7C', borderWidth: 1 },
